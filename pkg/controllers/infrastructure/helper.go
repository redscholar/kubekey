...
func (p *clusterScope) newPatchHelper(client ctrlclient.Client, obj ...ctrlclient.Object) error {
	helper, err := util.NewPatchHelper(client, obj...)
	if err != nil {
		return err
	}
...
func (p *clusterScope) ifPipelineCompleted(ctx context.Context, client ctrlclient.Client, owner ctrlclient.Object) (bool, error) {
	pipelineList := &kkcorev1.PipelineList{}
	if err := util.GetObjectListFromOwner(ctx, client, owner, pipelineList); err != nil {
		return false, err
	}
...
func (p *clusterScope) getVolumeMounts() ([]corev1.Volume, []corev1.VolumeMount) {
	...
	if p.Cluster.Status.ControlPlaneReady {
		// mount kubeconfig
		volumeMounts = append(volumeMounts, corev1.VolumeMount{
			Name:      "kubeconfig",
