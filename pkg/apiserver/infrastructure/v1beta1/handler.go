...
func (h *Handler) CreateKKCluster(req *restful.Request, resp *restful.Response) {
	...
	if err != nil {
		klog.Error(err)
		runtime.HandleBadRequest(resp, req, err)
		return
	}
...
func (h *Handler) UpdateKKMachine(req *restful.Request, resp *restful.Response) {
	...
	if err != nil {
		runtime.HandleError(resp, req, errors.Wrap(err, "failed to read patch body from request"))
		return
	}
	...
	if err != nil {
		runtime.HandleError(resp, req, errors.Wrap(err, "failed to encode old inventory object to JSON"))
		return
	}
	...
	if err != nil {
		runtime.HandleError(resp, req, errors.Wrap(err, "failed to apply patch and decode inventory"))
		return
	}

	if err = h.client.Patch(req.Request.Context(), updatedItem, ctrlclient.MergeFrom(&tmpl)); err != nil {
		runtime.HandleError(resp, req, err)
		return
	}
